  ...
  theme: {
    extend: {
      colors: {
        ...
        gold: {
          50: '#FBF8F0', 100: '#F5EEDB', 200: '#ECDCB5',
          300: '#C5A05E', 400: '#B8913F', 500: '#A07D35', 600: '#8B6B2A',
        },
        navy: {
          50: '#E8ECF0', 100: '#C5CEDA', 200: '#8A9BB5', 300: '#4E6890',
          400: '#2C4A73', 500: '#1A2332', 600: '#151E2B',
          700: '#0F1B2D', 800: '#0A1220', 900: '#060D17',
        },
