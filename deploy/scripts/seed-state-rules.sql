...
('NJ', 'New Jersey', true, 'basic_rulemaking', '2022-01-01', 'NJSA 46:14-10.4', true, true, true, true, 5, 4, 5, true, 5, 'STATE OF NEW JERSEY', 'REMOTE ONLINE NOTARY PUBLIC', 'NJSA 46:14-10.4', NULL, '[]'::jsonb, NULL, false, 'not_required', 'NJ Department of the Treasury', true, 'any', NULL),
